...
_ANALYZE_MEMBERS_SYSTEM = (
    ...
    "content 必须围绕当前讨论主题提出一个具体、自然、低压力的问题，引导用户补充观点、理由、例子或取舍。\n"
    "content 语气要亲切、轻量，像同伴顺着话题自然接一句；可以用“你觉得…”“会不会…”“有没有可能…”这类开放问法。\n"
    "content 禁止出现：发言少、参与度低、没听到你的声音、期待你的声音、大家期待、欢迎多分享、多说说、补充观点、会议进行中、讨论很热烈、内容质量正常、无需引导等泛化/评价性表达。\n"
    "content 不要称呼用户姓名，不要评价用户表现，不要说教，不要像主持人点名；必须像自然接话一样，只问与讨论主题直接相关的问题。\n"
    "如果无法生成主题相关问题，content 留空且 needs_prompt=false。\n"
    "content 示例：\n"
    "· 主题是“玩抽象”：你觉得玩抽象更像是在缓解压力，还是在制造新的社交暗号？\n"
    "· 主题是“搭子文化”：搭子关系里，边界感和陪伴感哪个更重要？\n"
    "· 主题是“心理防御机制”：把压力转成玩笑时，什么时候会变成逃避问题？\n\n"
    "【重要：anchor 约束】\n"
