...
const COI_LABELS: Record<CoiCategory, { label: string; color: string; bg: string; activeBg: string }> = {
  TE: { label: '触发', color: '#b45309', bg: '#fef9ee', activeBg: '#fef3c7' },
  EX: { label: '探索', color: '#1d4ed8', bg: '#f0f5ff', activeBg: '#dbeafe' },
  IN: { label: '整合', color: '#15803d', bg: '#f0fdf4', activeBg: '#dcfce7' },
  RE: { label: '解决', color: '#b91c1c', bg: '#fff5f5', activeBg: '#fee2e2' },
}
