...
import type { MetricSummary } from '../../../api/admin/task-score-analysis'
...
<template>
  <el-card class="analysis-card visual-card" shadow="never">
    <template #header>
      <div class="card-title">
        <strong>主要指标均值对比</strong>
...
.chart-row {
  display: grid;
  grid-template-columns: 72px minmax(110px, 1fr) 48px;
  align-items: center;
  gap: 8px;
  margin-top: 8px;
}
